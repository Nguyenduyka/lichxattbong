...
// ── BADGE API ──────────────────────────────────
// NOTE: Service Worker KHÔNG thể gọi setAppBadge trực tiếp trên Android Chrome.
// Chỉ relay về client window để trang tự gọi navigator.setAppBadge().
self.addEventListener('message', e => {
  ...
  if (type === 'SET_BADGE') {
    ...
    // Relay badge count về tất cả client window – trang sẽ tự gọi navigator.setAppBadge()
